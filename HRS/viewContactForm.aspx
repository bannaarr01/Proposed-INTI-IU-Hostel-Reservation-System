<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewContactForm.aspx.cs" Inherits="HRS.viewContactForm" %>
<!DOCTYPE html>
...
<head runat="server">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.css" integrity="sha512-Velp0ebMKjcd9RiCoaHhLXkR1sFoCCWXNp6w4zj1hfMifYB5441C+sKeBl/T/Ka6NjBiRfBBQRaQq65ekYz3UQ==" crossorigin="anonymous" />
    ...
    <link rel="icon" type="image/png" href="img/logoico.ico" />
        <title>INTI UI HOSTEL --Contact Forms</title>     
    <style type="text/css">
                 ...
                 <asp:HyperLink ID="hnlinkLogout" runat="server" CssClass="nav-link fas fa-user-times mr-3 mt-1" NavigateUrl="~/logout.aspx"> Sign Out</asp:HyperLink> 
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-md-6">
                          <h2>
                            <i class="fas fa-envelope-open-text mt-4" aria-hidden="true"></i><span style="font-family: Georgia, 'Times New Roman', Times, serif;"> Contact Forms</span></h2>
                        </div>
                      </div>
                    </div>
                  </header>
    ...
    <div class="container">
     ...
     <%--  <asp:Label ID="lblMssg" runat="server" CssClass="alert"  Text="" ForeColor="white" BackColor="#28a745" Font-Size="Larger"></asp:Label>--%>
            ...
            <div class="mt-2">
                    ...
                    <h4 class="text-center">Contact Forms</h4>
                       <div class="container table table-responsive table-striped">
        <asp:GridView ID="gvContact" runat="server" CssClass="col-md-12 mr-5 ml-5" AutoGenerateColumns="False"
           DataKeyNames="Id" CellPadding="10"
            ForeColor="#333333" GridLines="None"
            AllowPaging="True" OnPageIndexChanging="gvContact_PageIndexChanging" OnSelectedIndexChanging="gvContact_SelectedIndexChanging" PageSize="8" OnRowDeleting="gvContact_RowDeleting">
            <AlternatingRowStyle BackColor="White" ForeColor="#28a745" />
            <Columns>
                ...
                <asp:BoundField DataField="studId" HeaderText="ID" SortExpression="studId" />
            ...
            <FooterStyle BackColor="#28a745" Font-Bold="True" ForeColor="White" />
            <HeaderStyle BackColor="#28a745" Font-Bold="True" ForeColor="White" />
            <PagerStyle BackColor="#28a745" ForeColor="White" HorizontalAlign="Center" />
