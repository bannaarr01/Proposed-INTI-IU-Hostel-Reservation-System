<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="HRS.users" %>
<!DOCTYPE html>
...
<head runat="server">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.css" integrity="sha512-Velp0ebMKjcd9RiCoaHhLXkR1sFoCCWXNp6w4zj1hfMifYB5441C+sKeBl/T/Ka6NjBiRfBBQRaQq65ekYz3UQ==" crossorigin="anonymous" />
    ...
    <link rel="icon" type="image/png" href="img/logoico.ico" />
        <title>INTI UI HOSTEL --Users</title>     
    <style type="text/css">
                ...
                <%--<a href="login.aspx" class="nav-link">
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-md-6">
                          <h2>
                            <i class="fas fa-users mt-4"></i><span style="font-family: Georgia, 'Times New Roman', Times, serif;"> Users</span></h2>
                        </div>
                      </div>
                    </div>
                  </header>
    ...
    <div class="container">
     ...
     <%--  <asp:Label ID="lblMssg" runat="server" CssClass="alert"  Text="" ForeColor="white" BackColor="#28a745" Font-Size="Larger"></asp:Label>--%>
        ...
        <asp:GridView ID="gvUsers" runat="server" CssClass="mr-5 ml-5" AutoGenerateColumns="False"
           DataKeyNames="studId" CellPadding="9"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                  ...
                  <asp:ImageField DataImageUrlField="studentAvatar" HeaderText="Image"  ControlStyle-CssClass="img-fluid"  ControlStyle-Width="50px" ControlStyle-Height="50px"></asp:ImageField>     
